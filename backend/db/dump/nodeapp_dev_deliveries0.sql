...
CREATE TABLE `deliveries` (
  ...
  CONSTRAINT `deliveries_ibfk_1` FOREIGN KEY (`DeliveryGroupId`) REFERENCES `deliverygroups` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `deliveries_ibfk_2` FOREIGN KEY (`UserId`) REFERENCES `users` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
...
-- Dump completed on 2019-06-19 15:55:48
