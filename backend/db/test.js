      ...
      db.models.User
        ...
        .then(user => {
          ...
          .then(account => {
            ...
            .then(order => {
              db.models.Orderitem.create({UserId: user.id, OrderId: order.id, description: 'A-12345', qty: 1 ,unit_price: 5});
              db.models.Orderitem.create({UserId: user.id, OrderId: order.id, description: 'B-12345', qty: 2 ,unit_price: 4});
              db.models.Orderitem.create({UserId: user.id, OrderId: order.id, description: 'C-12345', qty: 3 ,unit_price: 3});
              db.models.Orderitem.create({UserId: user.id, OrderId: order.id, description: 'D-12345', qty: 4 ,unit_price: 2});
              db.models.Orderitem.create({UserId: user.id, OrderId: order.id, description: 'E-12345', qty: 5 ,unit_price: 1});
            });
          });
          ...
          .then(account => {
            ...
            .then(order => {
              db.models.Orderitem.create({UserId: user.id, OrderId: order.id, description: 'A-12345', qty: 2 ,unit_price: 4});
              db.models.Orderitem.create({UserId: user.id, OrderId: order.id, description: 'B-12345', qty: 3 ,unit_price: 3});
              db.models.Orderitem.create({UserId: user.id, OrderId: order.id, description: 'C-12345', qty: 4 ,unit_price: 2});
              db.models.Orderitem.create({UserId: user.id, OrderId: order.id, description: 'D-12345', qty: 5 ,unit_price: 1});
              db.models.Orderitem.create({UserId: user.id, OrderId: order.id, description: 'E-12345', qty: 1 ,unit_price: 5});
            });
          });
          ...
          .then(account => {
            ...
            .then(order => {
              db.models.Orderitem.create({UserId: user.id, OrderId: order.id, description: 'A-12345', qty: 3 ,unit_price: 3});
              db.models.Orderitem.create({UserId: user.id, OrderId: order.id, description: 'B-12345', qty: 4 ,unit_price: 2});
              db.models.Orderitem.create({UserId: user.id, OrderId: order.id, description: 'C-12345', qty: 5 ,unit_price: 1});
              db.models.Orderitem.create({UserId: user.id, OrderId: order.id, description: 'D-12345', qty: 1 ,unit_price: 5});
              db.models.Orderitem.create({UserId: user.id, OrderId: order.id, description: 'E-12345', qty: 2 ,unit_price: 4});
            });
          });
          ...
          .then(account => {
            ...
            .then(order => {
              db.models.Orderitem.create({UserId: user.id, OrderId: order.id, description: 'A-12345', qty: 4 ,unit_price: 2});
              db.models.Orderitem.create({UserId: user.id, OrderId: order.id, description: 'B-12345', qty: 5 ,unit_price: 1});
              db.models.Orderitem.create({UserId: user.id, OrderId: order.id, description: 'C-12345', qty: 1 ,unit_price: 5});
              db.models.Orderitem.create({UserId: user.id, OrderId: order.id, description: 'D-12345', qty: 2 ,unit_price: 4});
              db.models.Orderitem.create({UserId: user.id, OrderId: order.id, description: 'E-12345', qty: 3 ,unit_price: 3});
            });
          });
          ...
          .then(account => {
            ...
            .then(order => {
              db.models.Orderitem.create({UserId: user.id, OrderId: order.id, description: 'A-12345', qty: 5 ,unit_price: 1});
              db.models.Orderitem.create({UserId: user.id, OrderId: order.id, description: 'B-12345', qty: 1 ,unit_price: 5});
              db.models.Orderitem.create({UserId: user.id, OrderId: order.id, description: 'C-12345', qty: 2 ,unit_price: 4});
              db.models.Orderitem.create({UserId: user.id, OrderId: order.id, description: 'D-12345', qty: 3 ,unit_price: 3});
              db.models.Orderitem.create({UserId: user.id, OrderId: order.id, description: 'E-12345', qty: 4 ,unit_price: 2});
            });
          });
