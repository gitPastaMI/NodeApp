...
const router = new Router({
  ...
  routes: [
    ...
    // {path: '/orderitem',      name: 'orderitemnew',   component: OrderItem, props: true,  meta: {hasNavbar: false}},
    // {path: '/orderitem/:id',  name: 'orderitemedit',  component: OrderItem, props: true,  meta: {hasNavbar: false}},
